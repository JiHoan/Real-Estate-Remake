...
class NhaChoThueDetailModel extends Equatable {
  ...
  factory NhaChoThueDetailModel.fromJson(Map<String, dynamic> json) {
    return NhaChoThueDetailModel(
      ...
      soNamThueToiDa: json['thoi_gian_cho_thue_toi_da'] == 0 ? null : json['thoi_gian_cho_thue_toi_da'],
      cocBaoNhieuThang: json['coc_bao_nhieu_thang'] == 0 ? null : json['coc_bao_nhieu_thang'],
      giaChao: json['gia_chao_bao_nhieu'] == 0 ? null : json['gia_chao_bao_nhieu'],
      giaChot: json['gia_chot_bao_nhieu'] == 0 ? null : json['gia_chot_bao_nhieu'],
      baoNhieuNamDauKhongTangGia: json['bao_nhieu_nam_dau_khong_tang_gia'] == 0 ? null : json['bao_nhieu_nam_dau_khong_tang_gia'],
      baoNhieuNamCuoiTangBaoNhieuPhanTram: json['bao_nhieu_nam_dau_khong_tang_gia'] == 0 ? null : double.tryParse(json['nam_cuoi_tang_bao_nhieu'].toString()) ?? null,
