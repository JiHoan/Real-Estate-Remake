...
class KhachLauNamTabView extends StatefulWidget {
  final int id;
  final KhachTimMbBloc khachTimMbBloc;
  final CommonModel loaiHinh;
  final int tabChange;

  const KhachLauNamTabView(
...
class _KhachLauNamTabViewState extends State<KhachLauNamTabView> {
  String radioValue;
  int radioGroup;
  ...
  Future<void> _handleSubmit(BuildContext context) async {
    try {
      ...
      widget.khachTimMbBloc.add(UpdateKhachLauNam(id: widget.id, khachLauNam: 'CO', loaiHinh: radioValue));
    } catch (error) {
      print(error);
    }
  }
  ...
  void initState() {
    super.initState();
    radioValue = widget.loaiHinh.value;
    radioGroup = widget.loaiHinh.index;
  }
