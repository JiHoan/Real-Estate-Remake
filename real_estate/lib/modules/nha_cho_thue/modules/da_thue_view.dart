...
class DaThueView extends StatefulWidget {
  @override
  _DaThueViewState createState() => _DaThueViewState();
}

class _DaThueViewState extends State<DaThueView> {
  ...
  void _onScroll() {
    ...
    if (maxScroll - currentScroll <= _scrollThreshold) {
      _nhaChoThueBloc.add(LoadMoreDanhSachNhaChoThue(type: 'DA_THUE'));
    }
  }
