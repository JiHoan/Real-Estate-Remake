...
class TimNhaChoThueRepository {
  ...
  Future<NhaChoThueListModel> timNhaChoThue(
      {String quan, String phuong, String duong, double dienTich, int min, int max, String thanhPho}) async {
    return await _apiProvider.timNhaChoThue(
        quan: quan, phuong: phuong, duong: duong, dienTich: dienTich, min: min, max: max, thanhPho: thanhPho);
  }
}
